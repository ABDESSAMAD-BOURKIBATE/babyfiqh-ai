...
- **التعريف بنفسك:** عند أول لقاء أو عندما يسألك الطفل عن اسمك، قدم نفسك بقولك: "أنا جدك ليمانور" أو "أنا الجد ليمانور".
...
"صممني حفيدنا النجيب المهندس عبد الصمد بوركيبات".
`;
...
- **التعريف بنفسك:** عند أول لقاء أو عندما يسألك الطفل عن اسمك، قدمي نفسك بقولك: "أنا جدتك أمانيسا" أو "أنا الجدة أمانيسا".
...
"صممنا حفيدنا النجيب المهندس عبد الصمد بوركيبات".
`;
...
export const arUI: Translation = {
    ...
    ui: {
        ...
        women: 'أبرز النساء',
        about: 'عن التطبيق',
        library: 'مكتبة الوهج المقدس',
        furqan: 'مكتبة الفرقان',
        andalusLibrary: 'مكتبة الأندلس',
        gamesLibrary: 'مكتبة الامجاد',
        languageLearning: 'تعلم اللغات',
        videosLibrary: 'مكتبة المرئيات',
        ...
        safeZoneForChildren: 'منطقة آمنة للأطفال',
        searchVideo: 'ابحث عن فيديو...',
        noVideosInCategory: 'لا توجد فيديوهات في هذا القسم حالياً',
        noVideosMatch: 'لا توجد فيديوهات تطابق',
        ...
        gameOverTitle: 'انتهت المحاولات!',
        gameOverMessage: 'لقد نفدت قلوبك. لا تيأس، حاول مرة أخرى!',
        ...
        medium: 'متوسط',
        hard: 'صعب',
        arabicKnightsQuiz: 'فرسان الضاد',
        arabicKnights15Levels: 'فرسان الضاد - 15 مستوى',
        levels: 'مستوى',
        questions: 'أسئلة',
        randomQuestions: 'أسئلة عشوائية',
        starsSystem: 'نظام نجوم',
        strategicMind: 'العقل الاستراتيجي',
        strategicMindDesc: 'محاكي ذكاء اصطناعي لتحليل المواقف واتخاذ القرارات',
        activityLog: 'سجل النشاط',
        noRecentActivity: 'لا يوجد نشاط حديث',
        aiInsights: 'رؤى ونصائح الذكاء الاصطناعي',
        moreActivityNeeded: 'مطلوب المزيد من النشاط لتوليد الرؤى',
        recoverPassword: 'استعادة كلمة المرور',
        years: 'سنوات',
        liveTalk: 'محادثة مباشرة',
        speaking: 'يتحدث...',
        listening: 'استمع...',
        ...
        theme: 'المظهر',
        language: 'اللغة',
        educationalPortals: 'البوابات التعليمية',
        exploreWorldKnowledge: 'استكشف عالم المعرفة',
        games: {
