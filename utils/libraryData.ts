...
export interface LibraryItem {
    ...
    figures?: {
        men: Record<Language, string>[];
        women: Record<Language, string>[];
    };
}
...
export const goldenAges: LibraryItem[] = [
    { 
        id: 'rashidun_era', 
        type: 'golden_age', 
        names: { ar: 'عصر الخلفاء الراشدين', en: 'The Rashidun Caliphate', fr: 'Le Califat Rashidun', es: 'El Califato Rashidun', zgh: 'ⵜⴰⵙⵓⵜ ⵏ ⵉⵅⴰⵍⵉⴼⵏ ⵉⵔⴰⵛⵉⴷⵏ' },
        figures: {
            men: [
                { ar: 'أبو بكر الصديق', en: 'Abu Bakr Al-Siddiq', fr: 'Abou Bakr', es: 'Abu Bakr', zgh: 'ⴰⴱⵓ ⴱⴰⴽⵔ' },
                { ar: 'عمر بن الخطاب', en: 'Umar ibn Al-Khattab', fr: 'Omar', es: 'Umar', zgh: 'ⵄⵓⵎⴰⵕ' },
                { ar: 'عثمان بن عفان', en: 'Uthman ibn Affan', fr: 'Othman', es: 'Uthman', zgh: 'ⵄⵓⵜⵎⴰⵏ' },
                { ar: 'علي بن أبي طالب', en: 'Ali ibn Abi Talib', fr: 'Ali', es: 'Ali', zgh: 'ⵄⴰⵍⵉ' }
            ],
            women: [
                { ar: 'فاطمة الزهراء', en: 'Fatima Al-Zahra', fr: 'Fatima', es: 'Fátima', zgh: 'ⴼⴰⵟⵉⵎⴰ' },
                { ar: 'عائشة أم المؤمنين', en: 'Aisha bint Abu Bakr', fr: 'Aïcha', es: 'Aisha', zgh: 'ⵄⴰⵢⵛⴰ' }
            ]
        }
    },
    { 
        id: 'umayyad_era', 
        type: 'golden_age', 
        names: { ar: 'العصر الأموي', en: 'The Umayyad Era', fr: 'L\'ère Omeyyade', es: 'La Era Omeya', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⵎⴰⵡⵉⵜ' },
        figures: {
            men: [
                { ar: 'عمر بن عبد العزيز', en: 'Umar ibn Abdul Aziz', fr: 'Omar II', es: 'Umar II', zgh: 'ⵄⵓⵎⴰⵕ ⴱⵏ ⵄⴱⴷ ⵍⵄⴰⵣⵉⵣ' },
                { ar: 'معاوية بن أبي سفيان', en: 'Muawiyah I', fr: 'Muawiya I', es: 'Muawiya I', zgh: 'ⵎⵓⵄⴰⵡⵉⵢⴰ' }
            ],
            women: [
                { ar: 'عاتكة بنت يزيد', en: 'Atikah bint Yazid', fr: 'Atika', es: 'Atika', zgh: 'ⵄⴰⵜⵉⴽⴰ' }
            ]
        }
    },
    { 
        id: 'abbasid_era', 
        type: 'golden_age', 
        names: { ar: 'العصر العباسي الذهبي', en: 'The Abbasid Golden Age', fr: 'L\'Âge d\'Or Abbasside', es: 'La Edad de Oro Abasí', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⵄⴱⴱⴰⵙⵉⵜ ⵜⴰⵡⵔⴰⵖⵜ' },
        figures: {
            men: [
                { ar: 'هارون الرشيد', en: 'Harun al-Rashid', fr: 'Haroun ar-Rachid', es: 'Harun al-Rashid', zgh: 'ⵀⴰⵔⵓⵏ ⵔⵔⴰⵛⵉⴷ' },
                { ar: 'المأمون', en: 'Al-Ma\'mun', fr: 'Al-Ma\'mun', es: 'Al-Ma\'mun', zgh: 'ⵍⵎⴰⵎⵓⵏ' }
            ],
            women: [
                { ar: 'زبيدة بنت جعفر', en: 'Zubaidah bint Ja\'far', fr: 'Zoubaïda', es: 'Zubaidah', zgh: 'ⵣⵓⴱⴰⵢⴷⴰ' }
            ]
        }
    },
    { 
        id: 'andalusian_era', 
        type: 'golden_age', 
        names: { ar: 'العصر الأندلسي', en: 'The Andalusian Era', fr: 'L\'ère Andalouse', es: 'La Era Andalusí', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⵏⴷⴰⵍⵓⵙⵉⵜ' },
        figures: {
            men: [
                { ar: 'عبد الرحمن الداخل', en: 'Abd al-Rahman I', fr: 'Abd ar-Rahman I', es: 'Abderramán I', zgh: 'ⵄⴱⴷ ⵔⵔⴰⵃⵎⴰⵏ ⴷⴷⴰⵅⵉⵍ' },
                { ar: 'أبو القاسم الزهراوي', en: 'Al-Zahrawi', fr: 'Aboulcassis', es: 'Abulcasis', zgh: 'ⵣⵣⴰⵀⵔⴰⵡⵉ' }
            ],
            women: [
                { ar: 'ولادة بنت المستكفي', en: 'Wallada bint al-Mustakfi', fr: 'Wallada', es: 'Wallada', zgh: 'ⵡⴰⵍⵍⴰⴷⴰ' },
                { ar: 'لبنى القرطبية', en: 'Lubna of Cordoba', fr: 'Loubna', es: 'Lubna', zgh: 'ⵍⵓⴱⵏⴰ' }
            ]
        }
    },
    { 
        id: 'ottoman_era', 
        type: 'golden_age', 
        names: { ar: 'العصر العثماني', en: 'The Ottoman Era', fr: 'L\'ère Ottomane', es: 'La Era Otomana', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⵄⵜⵎⴰⵏⵉⵜ' },
        figures: {
            men: [
                { ar: 'محمد الفاتح', en: 'Mehmed the Conqueror', fr: 'Mehmet II', es: 'Mehmed II', zgh: 'ⵎⵓⵃⴰⵎⵎⴷ ⵍⴼⴰⵜⵉⵃ' },
                { ar: 'سليمان القانوني', en: 'Suleiman the Magnificent', fr: 'Soliman le Magnifique', es: 'Solimán el Magnífico', zgh: 'ⵙⵓⵍⴰⵢⵎⴰⵏ ⵍⵇⴰⵏⵓⵏⵉ' }
            ],
            women: [
                { ar: 'خرم سلطان', en: 'Hurrem Sultan', fr: 'Roxelane', es: 'Hurrem', zgh: 'ⵅⵓⵔⵔⴰⵎ' }
            ]
        }
    },
    { 
        id: 'fatimid_era', 
        type: 'golden_age', 
        names: { ar: 'العصر الفاطمي', en: 'The Fatimid Era', fr: 'L\'ère Fatimide', es: 'La Era Fatimí', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⴼⴰⵟⵉⵎⵉⵜ' },
        figures: {
            men: [
                { ar: 'المعز لدين الله', en: 'Al-Muizz li-Din Allah', fr: 'Al-Muizz', es: 'Al-Muizz', zgh: 'ⵍⵎⵓⵄⵉⵣ' }
            ],
            women: [
                { ar: 'ست الملك', en: 'Sitt al-Mulk', fr: 'Sitt al-Mulk', es: 'Sitt al-Mulk', zgh: 'ⵙⵜⵜ ⵍⵎⵓⵍⴽ' }
            ]
        }
    },
    { 
        id: 'mamluk_era', 
        type: 'golden_age', 
        names: { ar: 'عصر المماليك', en: 'The Mamluk Era', fr: 'L\'ère Mamelouke', es: 'La Era Mameluca', zgh: 'ⵜⴰⵙⵓⵜ ⵏ ⵉⵎⴰⵎⵍⵓⴽⵏ' },
        figures: {
            men: [
                { ar: 'الظاهر بيبرس', en: 'Baibars', fr: 'Baybars', es: 'Baibars', zgh: 'ⴱⴰⵢⴱⴰⵔⵙ' },
                { ar: 'سيف الدين قطز', en: 'Saif ad-Din Qutuz', fr: 'Qutuz', es: 'Qutuz', zgh: 'ⵇⵓⵟⵓⵣ' }
            ],
            women: [
                { ar: 'شجر الدر', en: 'Shajar al-Durr', fr: 'Chajar ad-Durr', es: 'Shajar al-Durr', zgh: 'ⵛⴰⵊⴰⵔ ⴷⴷⵓⵔ' }
            ]
        }
    },
    { 
        id: 'seljuk_era', 
        type: 'golden_age', 
        names: { ar: 'العصر السلجوقي', en: 'The Seljuk Era', fr: 'L\'ère Seldjoukide', es: 'La Era Selyúcida', zgh: 'ⵜⴰⵙⵓⵜ ⵜⴰⵙⵍⵊⵓⵇⵉⵜ' },
        figures: {
            men: [
                { ar: 'ألب أرسلان', en: 'Alp Arslan', fr: 'Alp Arslan', es: 'Alp Arslan', zgh: 'ⴰⵍⴱ ⴰⵔⵙⵍⴰⵏ' },
                { ar: 'نظام الملك', en: 'Nizam al-Mulk', fr: 'Nizam al-Mulk', es: 'Nizam al-Mulk', zgh: 'ⵏⵉⴹⴰⵎ ⵍⵎⵓⵍⴽ' }
            ],
            women: [
                { ar: 'تركان خاتون', en: 'Terken Khatun', fr: 'Terken Khatun', es: 'Terken Jatún', zgh: 'ⵜⴰⵔⴽⴰⵏ ⵅⴰⵜⵓⵏ' }
            ]
        }
    },
];
