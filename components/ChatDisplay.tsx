...
export const ChatDisplay: React.FC<ChatDisplayProps> = ({
  ...
  return (
    <div className="flex-grow w-full bg-transparent flex flex-col justify-between overflow-hidden relative">
      ...
      <div className="flex-grow overflow-y-auto p-4 md:p-6 space-y-6 relative z-10 scroll-smooth custom-scrollbar">
        ...
        {isLoading && (
          <div className="flex justify-start gap-4">
            ...
            <LoadingIndicator text={`${characterName} ${isAudioMode ? charInfo.thinkingText : charInfo.typingText}`} />
          </div>
        )}
