        ...
        <>
            ...
            >
                ...
                <div className="flex-grow py-6 px-5 flex flex-col gap-6 overflow-y-auto custom-scrollbar">
                    ...
                    {/* Games Library Button - Standardized */}
                    <button
                        onClick={onOpenGames}
                        className={`flex items-center gap-3 p-3.5 rounded-xl transition-all w-full group font-medium bg-gradient-to-r from-indigo-600 to-violet-700 text-white shadow-lg hover:shadow-indigo-600/30 transform hover:translate-y-[-2px]`}
                    >
                        <GameIcon className="w-5 h-5" />
                        <span>{t.gamesLibrary}</span>
                    </button>

                    {/* Al-Andalus Library Button */}
                    <button
                        onClick={onOpenAndalus}
                        className={`flex items-center gap-3 p-3.5 rounded-xl transition-all w-full group font-medium bg-gradient-to-r from-amber-700 to-amber-900 text-white shadow-lg hover:shadow-amber-700/30 transform hover:translate-y-[-2px]`}
                    >
                    ...
                    <button
                        onClick={onOpenAdhan}
                        className={`flex items-center gap-3 p-3.5 rounded-xl transition-all w-full group font-medium bg-gradient-to-r from-emerald-800 to-emerald-950 text-white shadow-lg hover:shadow-emerald-500/30 transform hover:translate-y-[-2px]`}
                    >
                        <MosqueIcon className="w-5 h-5 text-emerald-200" />
                        <span>{t.callOfMercy}</span>
                    </button>
