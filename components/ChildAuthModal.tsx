            ...
            <div className="w-full max-w-2xl animate-fade-in">
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    {filteredChildren.map(child => (
                        ...
                        >
                            <div className={`w-32 h-32 rounded-full border-4 border-white/10 flex items-center justify-center shadow-2xl transition-all group-hover:border-indigo-500 group-hover:shadow-indigo-500/50 overflow-hidden
